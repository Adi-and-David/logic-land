...
require([],function() {
    ...
    scene.add(light2);
    {
        waterNormals = new THREE.ImageUtils.loadTexture('../../static/threejs/textures/waternormals.jpg');
        ...
        var sky = new THREE.Mesh(
            ...
            new THREE.MeshPhongMaterial({
                map: THREE.ImageUtils.loadTexture('../../static/threejs/textures/skyboxsun25degtest.jpg')
            })
        );
